...
import SoniasinglaVoterSoniasinglaVoterVoter from './soniasingla/voter/soniasingla.voter.voter'
...
export default { 
  ...
  SoniasinglaVoterSoniasinglaVoterVoter: load(SoniasinglaVoterSoniasinglaVoterVoter, 'soniasingla.voter.voter'),
