...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryPollAll
   * @request GET:/soniasingla/voter/voter/poll
   */
  queryPollAll = (
    query?: {
    ...
    this.request<VoterQueryAllPollResponse, RpcStatus>({
      path: `/soniasingla/voter/voter/poll`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryVoteAll
   * @request GET:/soniasingla/voter/voter/vote
   */
  queryVoteAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<VoterQueryAllVoteResponse, RpcStatus>({
      path: `/soniasingla/voter/voter/vote`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
